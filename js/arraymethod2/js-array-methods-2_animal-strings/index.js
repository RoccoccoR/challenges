...
const hippoExists = console.log(animalStrings.includes("hippo"));
...
const firstAnimalStartingWithLetterP = console.log(
  animalStrings.find((animal) => animal.startsWith("p"))
);
